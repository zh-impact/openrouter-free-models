...
console.log(SCHEMA);
console.log('\nTo initialize your D1 database, run:');
console.log('npx wrangler d1 execute openrouter-models --local --file=./scripts/schema.sql');
console.log('\nFor production:');
console.log('npx wrangler d1 execute openrouter-models --file=./scripts/schema.sql');
