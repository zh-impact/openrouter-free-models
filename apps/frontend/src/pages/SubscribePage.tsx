      ...
      <div className="mb-6 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
        <div className="flex items-start space-x-3">
          <svg className="w-6 h-6 text-yellow-600 dark:text-yellow-400 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0v3a1 1 0 002 0z" clipRule="evenodd" />
          </svg>
          <div>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
          ...
          <dl className="space-y-3 text-sm">
            ...
            <div>
              ...
              <dd className="text-gray-600 dark:text-gray-400">在 Telegram 中发送 /unsubscribe 命令即可。</dd>
            </div>
            <div>
